                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary" href="<?= base_url('admin/pelanggan/tambah'); ?>">Tambah</a>
                        </div>
                        <div class="container">
                                ...
                                <table class="table table-bordered border-dark" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody class="table-primary text-dark">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="tombol">
                                                    <a class="btn btn-primary" href="<?= base_url('admin/pelanggan/edit/') . $row->id; ?>">
                                                        <ion-icon><i class="far fa-edit"></i></ion-icon>
                                                    </a>
                                                    <a class="btn btn-danger" onclick="return confirm('Yakin Akan Menghapus Data?')" href="<?= base_url('admin/pelanggan/hapus/') . $row->id; ?>">
